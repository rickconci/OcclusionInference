...
if __name__ == "__main__":
    ...
    parser.add_argument('--l1_penalty', default=0.1, type=float, help='sparsity parameter')
    
    parser.add_argument('--model', default='conv_AE', type=str, help='conv_AE ')
    ...
    parser.add_argument('--save_step', default=600, type=int, help='number of iterations after which a checkpoint is saved')
