...
class Solver(object):
    ...
    def test_plots(self):
        ...
        for i in range(3):
            ...
            traverse_z(self.net_copy, example_id, ID=str(i),output_dir=self.output_dir, 
        ...
        plotsave_tests(self.net_copy, test_data, self.output_dir, self.global_iter, n=20 )
