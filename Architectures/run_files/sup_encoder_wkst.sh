...
python main_mod.py --train True --ckpt_name None --testing_method supervised_encoder \
    ...
    --output_dir /home/riccardo/Desktop/Experiments/encoder_sup/arch/B_matched  \

cat <<EOT>> /home/riccardo/Desktop/Experiments/encoder_sup/arch/B_matched/LOGBOOK.txt
