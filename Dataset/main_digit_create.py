...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_samples', default=20, type=int, help='number of orig images')
    ...
    parser.add_argument('--linewidth', default=10, type=int, help='width of edgde around digits')
